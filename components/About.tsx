            ...
            <section id="about" className='custom bg-white py-20'>
                <div className='maxWidth flex flex-col items-center gap-28 lg:flex-row lg:justify-center'>
                    ...
                    <article className=" w-full text-center lg:w-1/3 lg:max-w-[600px] lg:text-left">
                        <h1 className="text-BlueP text-3xl">A Clínica Vitality nasceu da paixão e determinação da Dra. Gisele Rodrigues, fisioterapeuta especialista em Osteopatia, com mais de 12 anos de carreira.</h1>
                        ...
                        <p className="text-BlueP mt-4 text-lg">Aqui, cada paciente é tratado com exclusividade, com sessões de até uma hora, garantindo um atendimento de excelência, individualizado e focado nas necessidades específicas de cada um. Na Clínica Vitality, a crença é simples: "Tudo que fazemos com amor, dá certo." E esta filosofia é evidente em cada tratamento, cada sorriso de alívio e em cada história de transformação que a clínica tem o prazer de fazer parte.</p>
